...
## Sub-tasks
1. **Create and save** all protocol artifacts (`plan.md`, `context.md`, `log.md`, `00-setup.md`, and all future step files) in `.protocols/0011-codexmax/`.
2. **Make the first commit** with these files to branch `0011-codexmax`.
...
4. Commit: `git add .` then `git commit -m "feat(scope): subject [protocol-0011/00]"`. Push.
